 ...
 */
L.CanvasLayer.ScalarFieldPro = L.CanvasLayer.Field.extend({
    options: {
    ...
    _getRendererMethod: function () {
        switch (this.options.type) {
            case 'colormap':
                return this._drawImagePro.bind(this);
...
L.canvasLayer.scalarFieldPro = function (scalarField, options) {
    return new L.CanvasLayer.ScalarFieldPro(scalarField, options);
};